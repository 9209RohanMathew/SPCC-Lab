...
{
if(strcmp(_token, "+")==0 || strcmp(_token, "++")==0 || strcmp(_token, "-")==0 || strcmp(_token,
"--")==0 ||
strcmp(_token, "*")==0 || strcmp(_token, "/")==0 || strcmp(_token, "=")==0 || strcmp(_token,
"==")==0)
{
printf("operator: ");
printf("%s\n", _token);
